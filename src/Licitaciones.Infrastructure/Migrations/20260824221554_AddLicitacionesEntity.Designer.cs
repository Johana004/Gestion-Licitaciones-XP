...
namespace Licitaciones.Infrastructure.Migrations
{
    ...
    [Migration("20260824221554_AddLicitacionesEntity")]
    partial class AddLicitacionesEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Licitaciones.Domain.Entities.TipoCambio", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Activo = true,
                            FechaVigencia = new DateTime(2026, 8, 24, 22, 15, 52, 874, DateTimeKind.Utc).AddTicks(423),
                            Valor = 520.0000m
                        });
                });
