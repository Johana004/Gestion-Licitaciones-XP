...
namespace Licitaciones.Infrastructure.Migrations
{
    ...
    [Migration("20260824234211_AddOfertasEntity")]
    partial class AddOfertasEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Licitaciones.Domain.Entities.TipoCambio", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Activo = true,
                            FechaVigencia = new DateTime(2026, 8, 24, 23, 42, 10, 104, DateTimeKind.Utc).AddTicks(334),
                            Valor = 520.0000m
                        });
                });
